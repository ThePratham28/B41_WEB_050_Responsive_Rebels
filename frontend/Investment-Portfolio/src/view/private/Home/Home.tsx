    ...
    <>
      ...
      >
        ...
        <div style={{ flex: '1' }}>
          ...
          >
            <div style={{ marginRight: -300 }}>
              <img
                src='https://www.getquin.com/static/f9bf6ccbbf4a30ea252460415aa49a76/3c264/Analytics_EN_2fd5dca858.avif'
                height='60%'
                width='40%'
              />
            </div>
            <div style={{ width: '35%', marginRight: 50 }}>
              ...
              >
                <p>
                  ...
                  industry, asset class and track all the numbers that matter in
                  one dashboard. Visualize your holdings in clear charts and
                  adjust your investment strategy on the fly based on smart
                  data.
                </p>
                {/* <p>
                  Plan your future cash flows and know exactly when your
        ...
        >
          ...
          <div>
            <img
              src='https://www.getquin.com/static/e68bb8d0111d4494ceacfd4222eed642/880fa/lock.webp'
              height='60%'
              width='50%'
            />
          </div>
